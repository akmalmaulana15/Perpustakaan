...
<div style="margin: 30px 200px; background-color: rgb(255, 255, 255); box-shadow: black 2px 5px; box-shadow: #838383 0px -8px 20px; border-radius: 0px;">
    ...
    <h3>Ubah Data Siswa</h3>
        ...
        <br>
        Alamat : 
        <textarea name="alamat" class="form-control" rows="4" value="<?php echo $dt_siswa['alamat']?>"></textarea>
        <br>
        Kelas :
        ...
        <br>
        Username : 
        <input type="text" name="username" value="" class="form-control" value="<?php echo $dt_siswa['username']?>">
        <br>
        Password : 
        <input type="password" name="password" value="" class="form-control" value="<?php echo $dt_siswa['password']?>">
        <br>
